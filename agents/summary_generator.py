...
#         # Use a stronger model for summarization
#         self.model = "llama3.1:8b-instruct-q4_K_M"   # deepest reasoning & longest context
#         # fallback lighter: "llama3.1:8b-instruct-q4_K_M"

#     def generate_comprehensive_summary(self, article: Dict) -> str:
#         """
#         Generate a FULL comprehensive summary (200-400 words) of an AI/ML article.
#         Uses only the LLM for summarization (no truncation/clipping heuristics).
#         """
...
#         prompt = f"""
# You are an expert AI/ML news summarizer. Read the ENTIRE article below and produce a 
# comprehensive summary between 200 and 400 words. This summary must capture the full gist of the article.
...
# 2. Provide 3–5 key technical or business details
# 3. Explain the potential impact or significance
# 4. Avoid repeating fluff or filler
# 5. Be clear, engaging, and human-readable

# Important:
# - Do NOT copy large sentences from the article verbatim.
# - Do NOT skip key technical details (models, frameworks, research, policies, etc.).
# - Always summarize the full scope, not just the intro.
# """
...
#                 model=self.model,
#                 temperature=0.4,
#                 max_tokens=800  # allows longer summaries
#             )

#             # Cleanup: ensure within 400 words
#             words = summary.split()
#             if len(words) > 420:
